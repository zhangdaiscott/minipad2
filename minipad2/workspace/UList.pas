...
begin
   FListView.Color := OptionMan.Options.ListColor;
	FListView.Font := OptionMan.Options.ListFont;    // �����setcolor֮��ԭ����
end;
...
begin
   ...
   FListView.Cols.GetHeaderOrder (o_list);     // ������ͷ�Ϸŵ�Ч��
   for i := FPList.ColList.Low to FPList.ColList.High do
         ...
         if id = FPage.id then
      	begin
            ...
            begin
               ...
               else            // ����icon��small icon���ʹ��insert���ܲ��뵽��ȷλ�ã������������
               	Refresh;
            end
            else
               FListView.Items.Add (o_item);
...
//               	LangMan.GetItem(sr_prompt)) = mrCancel) then exit;
         	FListView.Items.SelectAll;
				CommandMan.ExecuteCommand (m_deleteitem);  // �˹��̱����������ʾ
         end;
      m_selectall:
      	FListView.Items.SelectAll;
      m_delete:
