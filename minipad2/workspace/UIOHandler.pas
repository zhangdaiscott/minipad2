...
type
   ...
   private
      ...
      function f_SelectFolder (const s_deffolder: widestring = ''): widestring;
		function ImportFrom (o_parent: TPageSuper; const s_pathfile: widestring; b_virtual: boolean; b_ignorenontxtfiles: boolean): boolean;  // ��ESC��ֹ
...
begin
   ...
   begin
      ...
      o_parent.Childs.AddChild (id);
      SaveMan.Save; // ��ֹ������ļ�ʱ��ʱ̫�����û���ֹ���򣬳������ݿ�������Ͷ�����Ӧ�ڵ������
...
begin
   ...
   begin
      ...
      if psub.CanAddChild (ptNote) then   // ����Ϊ�ļ���
         ExportGroupToFolder (psub, s + '\')
      else if psub.IsChildItemContainer then   // ����ͨѶ¼���б�ҳ������Ϊ mep �ļ�
